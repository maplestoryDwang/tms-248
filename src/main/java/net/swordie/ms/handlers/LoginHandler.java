...
//    @Handler(op = InHeader.SECURITY_PACKET)
//    public static void handleSecurityPacket(Client c, InPacket slea) {
////        int code = inPacket.decodeByte();
////        if (code == 1 || code == 2) {
////            OutPacket outPacket = new OutPacket(OutHeader.SECURITY_PACKET_);
////            outPacket.encodeByte(1);
...
//        byte mapleType = slea.decodeByte();
//        short mapleVersion = slea.decodeShort();
//        //String maplePatch = String.valueOf(slea.readShort());
//        if (mapleType != ServerConstants.MapleRegion || mapleVersion != ServerConstants.VERSION) {
//            c.close();
//        }
//
//
//        c.write(PrivateServerPacket());
//        c.write(ChangeSPWResult());
//
//    }

    public static OutPacket PrivateServerPacket() {
    ...
    public static OutPacket ChangeSPWResult() {
