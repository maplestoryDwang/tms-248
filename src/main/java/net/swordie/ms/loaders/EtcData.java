...
/*    @Loader(varName = "familiarSkills")
    ...
    public static void loadAndroidsFromWz() {
        String wzDir = ServerConstants.WZ_DIR + "/Etc.wz/Android_000.wz";
    ...
    public static void loadSoulCollectionFromWz() {
        String wzDir = ServerConstants.WZ_DIR + "/Etc.wz/Etc_004.wz/SoulCollection.img.xml";
        File dir = new File(wzDir);
    ...
    public static void loadCommodityFormWz(){
        String wzDir = ServerConstants.WZ_DIR + "/Etc.wz/Etc_002.wz/Commodity.img.xml";
        File dir = new File(wzDir);
