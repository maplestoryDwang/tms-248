...
public class ItemData {
    ...
    public static void loadEquipsFromWz() {
        String wzDir = ServerConstants.WZ_DIR + "/Character_000.wz";

        String[] subMaps = new String[]{"Accessory_000.wz", "Android_000.wz", "Cap_000.wz", "Cape_000.wz", "Coat_000.wz", "Dragon_000.wz", "Face_000.wz", "Glove_000.wz",
                "Longcoat_000.wz", "Longcoat_001.wz", "Mechanic_000.wz", "Pants_000.wz", "PetEquip_000.wz", "Ring_000.wz", "Shield_000.wz", "Shoes_000.wz", "Totem_000.wz",
                "Weapon_000.wz", "Weapon_001.wz", "Weapon_002.wz", "Weapon_003.wz", "Weapon_004.wz",
                "ArcaneForce_000.wz", "AuthenticForce_000.wz"};
...
//                        equip.setInvType(equip.isCash() ? InvType.CASH_EQUIP : InvType.EQUIP);
    ...
    public static void saveItems(String dir) {
        ...
        for (ItemInfo ii : getItems().values()) {
            try (DataOutputStream dataOutputStream = new DataOutputStream(new FileOutputStream(new File(dir + "/" + ii.getItemId() + ".dat")))) {
                ...
                dataOutputStream.writeUTF(ii.getInvType() != null ? ii.getInvType().toString() : "");
                ...
                log.error(" err ii.getItemId()" + ii.getItemId());
                e.printStackTrace();
    ...
    public static void loadPetsFromWZ() {
        ...
        File petDir = new File(String.format("%s/%s", wzDir, "Pet_000.wz"));
    ...
    public static void loadItemsFromWZ() {
        String wzDir = ServerConstants.WZ_DIR + "/Item.wz";
        String[] subMaps = new String[]{"Cash_000.wz", "Consume_000.wz", "Etc_000.wz", "Install_000.wz", "Install_001.wz","Install_002.wz","Install_003.wz","Special_000.wz"}; // not pet
        for (String subMap : subMaps) {
            File subDir = new File(String.format("%s/%s", wzDir, subMap));
            File[] files = subDir.listFiles();
            Arrays.stream(files).parallel().forEach(file -> {
...
//                    log.info(id);
    ...
    public static void loadItemSetsFromWZ() {
        String wzDir = ServerConstants.WZ_DIR + "/Etc.wz/Etc_004.wz";
    ...
    private static void loadStartingItemsFromWZ() {
        String wzDir = ServerConstants.WZ_DIR + "/Etc.wz/Etc_002.wz";
    ...
    public static void main(String[] args) {
        System.setProperty("wz.dir", "E:\\oldmxd\\tms248");
